...
$string['indexicon'] = 'Unit index icon';
$string['indexicon_help'] = 'An optional Font Awesome icon name, such as fa-book or fa-pen, shown for this unit in the navigation panel. Where the unit has activities with completion tracking the icon sits inside the progress ring, and a green tick replaces it once every activity is complete. Leave empty to show progress alone.';
...
$string['notcompletedname'] = '{$a} is not complete';
...
$string['showindexactivities'] = 'Show activities in the unit index';
$string['showindexactivities_help'] = 'When enabled, the unit currently being viewed lists its completion-tracked activities in the navigation panel, each with an indicator showing whether it is complete. Only the selected unit lists its activities, so the panel stays a list of units.';
